{
  /* <div className={"mt-[50px] w-full h-full justify-center items-center"}>
        <div className={"flex justify-center items-center"}>
          <div
            className={
              "flex cursor-pointer flex-col md:flex-row 2xl:w-[2160px] items-center gap-[50px]  justify-around md:gap-[250px]"
            }
          >
            ...
            <div
              className={
                "w-[200px] h-[60px] flex justify-center items-center flex-row border-[1px] rounded-[5px] border-text3"
              }
            >
        ...
        >
          <div
            className={
              "grid xl:grid-cols-3 lg:w-[850px] xl:w-fit grid-cols-1 lg:grid-cols-3  md:grid-cols-2 2xl:grid-cols-4 gap-[50px]"
            }
          >
            <div
              className={
                "bg8 p-[20px] lg:pb-[60px] xl:pb-[40px] relative cursor-pointer"
              }
            >
              ...
              <h3
                className={"text-text2 mt-[10px] text-lg xl:text-xl w-[250px]"}
              >
                Lorem ipsum dolor sit amet consectetur.
              </h3>
              <h4
                className={"absolute text-lg !text-[#98BCD6] right-4 bottom-3"}
              >
                ~Yazar Adı Soyadı
              </h4>
            </div>
          ...
          >
            <div
              className={
                "bg-bg2 hover:bg-bg6 cursor-pointer mt-[17px] w-fit h-[35px] px-[30px] py-[30px] flex justify-center items-center rounded-md"
              }
            >
...
}
{
  /* <div className={"mt-[200px]"}>
        <div className={"flex flex-col justify-center items-center"}>
          ...
          <h2
            className={
              "font4 text-lg md:text-xl w-[330px] sm:w-[515px] mt-[20px] text-text2 text-center"
            }
          >
  ...
  /* <div
      ...
      >
        <div className={"flex flex-col justify-center items-center"}>
          ...
          >
            Utilizamos sólo materiales de la mejor calidad del mercado para
            proporcionar los mejores productos a nuestros pacientes.
          </h2>
        </div>
        <AccordionEmre />
      </div>
      <div className={"mt-[90px] flex justify-center items-center"}>
        <div
          className={
            "lg:w-[900px] md:w-[700px] w-[330px] xl:w-[1064px] h-fit pb-10 md:h-[392px] bg-[#374857] rounded-[30px]  xl:gap-[50px] flex justify-center items-center flex-col md:flex-row"
          }
        >
          <div
            className={
          ...
          >
            ...
            <div
              ...
              className={
                "bg-bg2 hover:bg-bg7 cursor-pointer cursor-pointer w-[200px] h-[50px] mt-[20px] md:mt-[40px] px-[0px] flex justify-center items-center py-[20px] rounded-lg"
              }
            >
